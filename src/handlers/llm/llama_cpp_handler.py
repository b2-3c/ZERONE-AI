...
class LlamaCPPHandler(OpenAIHandler):
    ...
    def show_install_dialog(self, button):
        ...
        if not can_escape_sandbox():
            ...
            command_entry.set_text("flatpak --user override --talk-name=org.freedesktop.Flatpak --filesystem=home com.zeroneai.app")
            ...
            copy_btn.connect("clicked", lambda btn: self.copy_to_clipboard("flatpak --user override --talk-name=org.freedesktop.Flatpak --filesystem=home com.zeroneai.app"))
