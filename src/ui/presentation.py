...
class PresentationWindow(Adw.Window):
    ...
    def build_pages(self):
        ...
        pages = [
            {
                "title": _("Welcome to ZERONE AI!"),
                "description": _("Your ultimate AI Waifu assistant."),
                "picture": "/com/zeroneai/app/images/logo.svg",
                "actions": [
                    {
                        "label": _("Github Page"),
                        "classes": [],
                        "callback": lambda x: subprocess.Popen(["xdg-open", "https://github.com/ZERONEAI/ZeroneAI"]), 
                    }
                ]
            },
            {
                "title": _("Choose your favourite AI Language Model"),
                "description": _("ZERONE AI can be used with mutiple models and providers!\n<b>Note: It is strongly suggested to read the Guide to LLM page</b>"),
                "widget": self.__steal_from_settings(settings.LLM),
                "actions": [
                    {
                        "label": _("Guide to LLM"),
                        "classes": ["suggested-action"],
                        "callback": lambda x: subprocess.Popen(["xdg-open", "https://github.com/b2-3c/ZeroneAI/wiki/User-guide-to-the-available-LLMs"]),
                    }
                ] 
            },
            {
                "title": _("Chat with your documents"),
                "description": _("ZERONE AI can retrieve relevant information from documents you send in the chat or from your own files! Information relevant to your query will be sent to the LLM."),
            ...
            },
            {
                ...
                "description": _("You can speak to ZERONE AI! Use any TTS/STT provider in any language, with translation support!"),
            ...
            {
                "title": _("Extensions"),
                "description": _("You can extend ZERONE AI's functionalities using extensions! They are easy to make and to install!"),
                "picture": "/com/zeroneai/app/images/extension.svg",
                "actions": [
                    {
            ...
            },
            {
                ...
                "description": _("ZERONE AI can run commands on your system! By enabling command virtualization, you will only run commands inside the flatpak environment, avoiding to create damages to your system.\n\n <b>Pay attention on what you run! Commands generated might harm your system!</b>"),
        ...
        if not can_escape_sandbox():
            pages.append({
                ...
                "description": _("zeroneai does not have enough permissions to run commands on your system."),
                "picture": "/com/zeroneai/app/images/error.svg",
                "actions": [
                    {
                        "label": "Learn more",
                        "classes": ["suggested-action"],
                        "callback": lambda x: subprocess.Popen(["xdg-open", "https://github.com/zeroneai/zeroneai?tab=readme-ov-file#permission"]),
                    }
                ]
            })
        pages.append({
    ...
    def __create_copybox(self): # I feel like it's a little out of place from the look, but maybe I'm wrong.
        ...
        copy = CopyBox("flatpak --user override --talk-name=org.freedesktop.Flatpak --filesystem=home moe.zeroneai.zeroneai", "bash", parent=box)
