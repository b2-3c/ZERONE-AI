...
class ExplorerPanel(Gtk.Box):
    ...
    def go_back_in_explorer_panel(self, *a):
        ...
        if self.main_path == "/".join(self.controller.zeroneai_dir.split("/")[3:]):
            self.set_main_path("~")
        GLib.idle_add(self.update_folder)
            ...
            if os.path.exists(os.path.expanduser(self.main_path)):
                ...
                if (
                    ...
                    or (
                        ...
                        == 0
                        and not self.controller.zeroneai_settings.hidden_files
                    )
