...
class Extension(Gtk.Window):
    def __init__(self,app):
        ...
        self.controller : ZeroneController = app.win.controller
    ...
    def update(self):
        ...
        download_button.connect("clicked", lambda x : subprocess.Popen(get_spawn_command() + ["xdg-open", "https://github.com/b2-3c/ZeroneAI/wiki/User-guide-to-Extensions"]))
    ...
    def on_folder_button_clicked(self, widget):
        filter = Gtk.FileFilter(name="ZERONE AI Extensions", patterns=["*.py"])
