...
class ReplaceHelper:
    ...
    def get_user() -> str:
        ...
        if ReplaceHelper.controller is None:
            return "User"
        return ReplaceHelper.controller.zeroneai_settings.username
    ...
    def get_tools_json() -> str:
        ...
        """
        tools_settings = ReplaceHelper.controller.zeroneai_settings.tools_settings_dict
        enabled_tools = {}
        ...
        if not ReplaceHelper.controller.zeroneai_settings.websearch_on:
