...
def convert_history_openai(history: list, prompts: list, vision_support : bool = False):
    """Converts ZERONE AI history into OpenAI format

    Args:
        history (list): ZERONE AI history 
...
def aggregate_messages(messages: list, format="zeroneai"):
    ...
    Args:
        ...
        format (str): Message format ("zeroneai" or "openai").
    ...
    formats = {
        "zeroneai": {"role": "User", "content": "Message"},
...
def embed_image(text: str, image: str):
    ...
    Combines text and image URL into a single ZERONE AI message string.
...
def convert_history_zeroneai(openai_history: list, vision_support: bool = False):
    """
    Converts OpenAI history back into ZERONE AI format.
    ...
    Returns:
        tuple: A tuple (zeroneai_history, prompts) where zeroneai_history is a list
    ...
    return zeroneai_history, prompts
